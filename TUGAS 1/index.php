...
nav a {
  ...
  /* Flexbox supaya teks benar-benar di tengah */
  display: flex;
  align-items: center;
  justify-content: center;
...
<div class="main">
  <nav>
    <a href="form_ucapan.php">FORM UCAPAN</a>
    <a href="kalkulator.php">KALKULATOR</a>
    <a href="ganjil_genap.php">BILANGAN GANJIL/GENAP</a>
    <a href="nilai_huruf.php">NILAI HURUF</a>
